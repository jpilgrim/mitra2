 ...
 * @since Feb 17, 2012
 */
public class DelegatingMitraOrderedSet extends MitraOrderedSet {
	...
	public DelegatingMitraOrderedSet(@SuppressWarnings("rawtypes") List raws,
	...
	public boolean add(int index, MObject mObject) {
		if (raws.contains(mObject.getValue())) return false;
