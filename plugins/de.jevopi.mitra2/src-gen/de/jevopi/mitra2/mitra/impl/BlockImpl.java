 ...
 * <ul>
 *   <li>{@link de.jevopi.mitra2.mitra.impl.BlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockImpl extends StatementImpl implements Block
{
  ...
  {
    return MitraPackage.Literals.BLOCK;
  }
  ...
  public EList<BlockStatement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<BlockStatement>(BlockStatement.class, this, MitraPackage.BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MitraPackage.BLOCK__STATEMENTS:
