 ...
 * <!-- end-user-doc -->
 * @see de.jevopi.mitra2.mitra.MitraPackage#getBooleanOperator()
 * @model
 * @generated
 */
public enum BooleanOperator implements Enumerator
{
  ...
  /**
   * The '<em><b>Andsc</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #ANDSC_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Orsc</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #ORSC_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Andsc</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Andsc</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #ANDSC
   * @model name="andsc" literal="&&"
   * @generated
   * @ordered
   */
  public static final int ANDSC_VALUE = 2;

  /**
   * The '<em><b>Orsc</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Orsc</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #ORSC
   * @model name="orsc" literal="||"
   * @generated
   * @ordered
   */
  public static final int ORSC_VALUE = 3;
  ...
  public static BooleanOperator get(int value)
  {
    switch (value)
    {
      ...
      case ANDSC_VALUE: return ANDSC;
      case ORSC_VALUE: return ORSC;
    }
    return null;
  }
