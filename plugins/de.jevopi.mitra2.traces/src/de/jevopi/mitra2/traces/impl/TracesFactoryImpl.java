...
public class TracesFactoryImpl extends EFactoryImpl implements TracesFactory {
	...
	public static TracesFactory init() {
		try {
			TracesFactory theTracesFactory = (TracesFactory)EPackage.Registry.INSTANCE.getEFactory("http://mitra2.jevopi.de/traces"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TracesPackage.TRACE_RECORD: return createTraceRecord();
			case TracesPackage.TRACE: return createTrace();
			case TracesPackage.TRACE_ELEMENT: return createTraceElement();
			case TracesPackage.MODEL: return createModel();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case TracesPackage.PARAMETER_TYPE:
