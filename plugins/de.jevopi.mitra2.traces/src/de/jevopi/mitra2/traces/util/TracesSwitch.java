 ...
 */
package de.jevopi.mitra2.traces.util;

import de.jevopi.mitra2.traces.*;
...
public class TracesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TracesPackage.TRACE_RECORD: {
